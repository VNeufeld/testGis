...
@XmlRootElement(name = "DemandedObjects", namespace = "")
public class DemandedObjects {

    @XmlElement(name = "DemandedObject", required = true)
    protected String demandedObject;
     ...
     *     
     */
    public void setDemandedObject(String value) {
