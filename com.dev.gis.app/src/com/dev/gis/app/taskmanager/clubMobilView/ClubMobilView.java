				...
				if (obj instanceof Button) {
					...
					if ( b.getSelection() ) {
						if ( "Stations".equals(b.getText()))
							ClubMobilModelProvider.INSTANCE.locationType = 1;
						else if ( "City".equals(b.getText()))
							ClubMobilModelProvider.INSTANCE.locationType = 2;
						else if ( "Airport".equals(b.getText()))
							ClubMobilModelProvider.INSTANCE.locationType = 4;
					}
				}
				logger.info("Select LocationType "+ClubMobilModelProvider.INSTANCE.locationType);
			}
		...
		SelectionListener sl = new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent event) {
				...
				if (obj instanceof Button) {
					Button b = (Button) obj;
					if ( b.getSelection() ) {
						ClubMobilModelProvider.INSTANCE.module = 2;
					}
					else
						ClubMobilModelProvider.INSTANCE.module = 1;
				}
				logger.info("Select Modle "+ClubMobilModelProvider.INSTANCE.module);
			}
	...
	protected static class CrossOfferOperatorControl extends ObjectTextControl {
		...
		public void saveValue(String value) {
			if ( StringUtils.isEmpty(value))
				value = "1";
			ClubMobilModelProvider.INSTANCE.crossOfferOperator = value;
